...
\item \hyperlinkref{4405531934545770603}{At-example with \texttt{text/markdown} MIME}
\item \hyperlinkref{5969831508618549664}{Setup blocks}
\item \hyperlinkref{9168975007727874841}{Eval blocks}
...
\section{At-example with \texttt{text/markdown} MIME}



\label{4405531934545770603}{}


The following should render properly, by parsing the \texttt{text/markdown} with the Markdown parser:
...
\label{9168975007727874841}{}


Eval blocks that evaluate to \texttt{nothing} are hidden:



Eval blocks that evaluate to \texttt{Markdown.MD} are rendered:
